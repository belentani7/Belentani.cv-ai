# AGENTS.md -- Belentani.cv-ai

Reglas para agentes y personas que trabajen en este repositorio.

## Proposito del proyecto

AI-powered document studio ÔÇö CVs, cover letters, presentations. Ôé¼0.99 one-time, GDPR compliant, AES-256

Stack detectado: Node.js, Next.js, React, Tailwind, TypeScript, Deploy: vercel.json.
