# ADR-001 -- Auditoria documental y stack de Belentani.cv-ai
Fecha: 2026-09-25 | Estado: aceptado

## Contexto

El repositorio carecia de cadena documental formal (PRD/SRS/SDD/ADR/plan) y de
reglas explicitas para agentes. Stack detectado: Node.js, Next.js, React, Tailwind, TypeScript, Deploy: vercel.json.
