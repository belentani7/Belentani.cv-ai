# Plan -- Auditoria y documentacion al 100% (Belentani.cv-ai)
...
- [x] `docs/prd/prd-belentani-cv-ai.md`.
- [x] `docs/srs/srs-belentani-cv-ai.md`.
- [x] `docs/design/design-belentani-cv-ai.md`.
