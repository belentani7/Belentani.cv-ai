# SRS -- Belentani.cv-ai
Fecha: 2026-09-25 | Estado: Draft | Traza a: PRD prd-belentani-cv-ai.md

## Requisitos funcionales

| ID | Requisito | Traza PRD | Prioridad |
|---|---|---|---|
| FR-001 | El sistema implementa: npm run build | F1 | Must |
| FR-002 | El sistema implementa: npm run db:generate | F2 | Must |
| FR-003 | El sistema implementa: npm run db:migrate | F3 | Must |
| FR-004 | El sistema implementa: npm run db:push | F4 | Must |
| FR-005 | El sistema implementa: npm run db:reset | F5 | Must |
| FR-006 | El sistema implementa: npm run dev | F6 | Must |
| FR-007 | El sistema implementa: npm run lint | F7 | Must |
| FR-008 | El sistema implementa: npm run start | F8 | Must |
